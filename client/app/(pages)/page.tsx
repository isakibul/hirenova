...
export default function Home() {
  ...
  return (
    <>
      ...
      <section
        id="features"
        className="grid gap-4 px-5 md:px-[10vw] py-10 md:grid-cols-3"
      >
        {[
          {
            icon: "target",
          ...
          <div key={i} className="site-border site-card rounded-lg border p-4">
            <div className="site-badge mb-3 inline-flex h-8 w-8 items-center justify-center rounded-md">
              <Icon name={f.icon as "target" | "file" | "bell"} />
            </div>
