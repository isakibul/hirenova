...
function getMessage(response: UsersResponse | UserDetailResponse) {
...
function getUserId(user: UserSummary) {
...
export default function ManageUsersClient({
  ...
  async function handleMakeAdmin(user: UserSummary) {
    const userId = getUserId(user);
          ...
          <aside className="site-border site-card rounded-lg border">
            ...
            <div className="border-t border-[var(--site-border)]">
              <div className="px-4 py-3">
                ...
                <p className="site-muted mt-1 text-xs">
                  Select a user from the list to inspect backend account data.
                </p>
              </div>
          ...
          <div className="site-border site-card w-full max-w-md rounded-lg border">
            ...
            <div className="flex flex-col-reverse gap-2 p-5 sm:flex-row sm:justify-end">
              <button
                ...
                disabled={deletingUserId === getUserId(userPendingDelete)}
