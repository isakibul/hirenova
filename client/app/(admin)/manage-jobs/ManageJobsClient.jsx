...
import { formatDateTime, getRecordId as getJobId } from "@lib/ui";
...
import { approvalFilterOptions, buildPayload, emptyForm, formatApprovalHistoryAction, formatApprovalStatusRole, getApprovalHistoryClass, getFormFromJob, jobSortOptions, statusFilterOptions, validateJobForm, } from "./jobUtils";
        ...
        <div className="mt-6 grid items-start gap-3 2xl:grid-cols-3">
          <div className="site-border site-card min-w-0 overflow-hidden rounded-lg border 2xl:col-span-2">
            ...
            <ManageJobsTable
              ...
              onEdit={handleEdit}
              onOpenHistory={setJobHistoryTarget}
              onPageChange={setPage}
              onReview={(job, approvalStatus) => approvalStatus === "declined"
                ? handleDecline(job)
                : reviewJob(job, approvalStatus)}
