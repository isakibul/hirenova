    ...
    <section className="px-5 py-8 md:px-[6vw] lg:px-[8vw]">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          ...
          >
            {isRefreshing ? (
              <LoadingCircle className="h-3.5 w-3.5" label="Refreshing operations" />
            ) : (
              <Icon name="chart" />
            )}
            Refresh
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p className="site-muted mt-1 text-xs">
                    Successful sensitive actions only. Request bodies are not stored.
                  </p>
                </div>
                <SelectField
                  value={auditAction}
              ...
              <table className="w-full min-w-[720px] border-collapse text-left text-sm">
                ...
                <tbody>
                  {isLoadingAudit ? (
                    ...
                    auditLogs.map((log) => (
                      <tr key={log.id} className="border-t border-[var(--site-border)]">
                ...
                <tbody>
                  {isLoadingEmail ? (
                    ...
                    emailEvents.map((event) => (
                      <tr key={event.id} className="border-t border-[var(--site-border)]">
                        ...
                        <td className="site-muted px-4 py-3 align-top text-xs">
                          {event.errorMessage || event.providerMessageId || "No provider id"}
