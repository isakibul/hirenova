    ...
    >
      <label className="site-soft block text-xs font-medium">
        ...
        <input
          ...
          aria-describedby={
            visibleErrors.username ? "signup-username-error" : undefined
          }
      ...
      <label className="site-soft mt-4 block text-xs font-medium">
        ...
        <input
          ...
          aria-describedby={
            visibleErrors.email ? "signup-email-error" : undefined
          }
          className="site-field mt-1.5 w-full rounded-md border px-3 py-2 text-sm focus:outline-none"
      ...
      <label className="site-soft mt-4 block text-xs font-medium">
        ...
        <PasswordField
          ...
          aria-describedby={
            visibleErrors.password ? "signup-password-error" : undefined
          }
      ...
      <fieldset
        className="site-soft mt-4 block text-xs font-medium"
      ...
      <StatusNotice className="mt-4 text-xs" tone="success">
        {success}
      </StatusNotice>
      {createdEmail ? (
        <div className="mt-3">
          <button
            ...
            className="site-border site-field inline-flex w-full items-center justify-center gap-2 rounded-md border px-3 py-2 text-xs font-semibold disabled:opacity-70"
          >
            {isResending ? (
              <LoadingCircle
          ...
          <StatusNotice className="mt-2 text-xs" tone="success">
            {resendNotice}
          </StatusNotice>
        </div>
      ) : null}
      ...
      >
        {isSubmitting ? (
          <LoadingCircle className="h-3.5 w-3.5" label="Creating account" />
        ) : null}
